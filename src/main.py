...
async def get_fibo_levels(stock_id:str, stock_name:str='', period: int = 1, time_frame: str='y') -> response_fibo_module:
    """
...
async def get_bullish_candles(stock_id:str, stock_name:str='', period:int = 1, time_frame:str='y') -> response_candle_module:
    """Method to validate the bullish candlestick of a given stock."""
    request = request_candle_module(stock_id=stock_id,
                                    stock_name=stock_name,
                                    period=period,
                                    time_frame=time_frame)
...
async def get_bullish_indicators(stock_id:str, stock_name:str='', period:int = 1, time_frame:str='y') -> response_indicator_module:
    """Method to validate the bullish indicators of a given stock."""
    request = request_indicator_module(stock_id=stock_id,
                                    stock_name=stock_name,
                                    period=period,
                                    time_frame=time_frame)
...
async def get_support_resistance_levels(stock_id:str, stock_name:str='', period:int = 1, time_frame:str='y') -> response_SR_module:
    """Method to extract the support resistance levels of a given stock."""
    request = request_SR_module(stock_id=stock_id,
                                 stock_name=stock_name,
                                 period=period,
                                 time_frame=time_frame)
    candlestick_response = SupportResistanceIndicator().get_support_resistance_levels(request)
    return candlestick_response
